...
static Connection cnx;
	...
	public static void connecterBd(){
		...
		String url = "jdbc:sqlserver://localhost:1433; instanceName=SQLEXPRESS; databaseName=GSBV3;user=Admin;"
				+ "password=tiralarc; encrypt=true; trustServerCertificate=true"; // url : chaine de connexion
		// try permet d'essayer de lancer la connexion
		Class.forName("com.microsoft.sqlserver.jdbc.SQLServerDriver");
			cnx = DriverManager.getConnection(url,"Admin","tiralarc"); 
		} 
